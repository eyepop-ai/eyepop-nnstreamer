 ...
 */
NNS_API void gst_tensor_filter_install_properties (GObjectClass * gobject_class);
 ...
 */
NNS_API void gst_tensor_filter_common_open_fw (GstTensorFilterPrivate * priv);

/**
 * @brief Close NN framework.
 */
NNS_API void gst_tensor_filter_common_close_fw (GstTensorFilterPrivate * priv);
