...
class NNS_API tensor_filter_subplugin
{
  ...
  GstTensorFilterFramework fwdesc; /**< Represents C/V1 wrapper for the derived
                                      ...
                                      access this anyway; the base class will
                                      handle this with the C wrapper functions, base static-functions, and base constructors/destructors. */
...
#warn C++ 11 is required for safe execution
   ...
   */
  template <typename T> static void unregister_subplugin (T *emptyInstance)
  {
